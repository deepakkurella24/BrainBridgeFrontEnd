...
import { Pencil, Check, X, Plus, Target, Camera,AlertCircle } from 'lucide-react';
...
//   about: "I am a mern stack developer, come on lets grow together",
//   offered: ["Figma", "User Research", "Prototyping", "Wireframing"],
//   wanted: ["React", "Python"],
//   profileURL: "https://i.pravatar.cc/300?u=sarah",
//   goal: 'To build useful apps'
// }
          ...
          <div className={`w-full p-4 rounded-2xl transition-all border ${isEdit ? 'bg-slate-50 border-slate-200 shadow-inner' : 'bg-blue-50/40 border-blue-100/50'}`}>
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 text-left">
                <p className="text-[9px] text-slate-400 uppercase tracking-widest font-bold mb-0.5">Primary Goal</p>
                {isEdit ? (
                  <input
...
export default Profile;
              ...
              // <button
              //   onClick={() => setIsEdit(true)}
              //   className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold shadow-lg shadow-blue-500/20 active:scale-95 transition-all duration-200"
              // >
              //   <Pencil size={18} />
              //   Edit Profile
              // </button>