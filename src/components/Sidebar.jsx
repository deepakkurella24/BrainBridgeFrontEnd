...
const Sidebar = (props) => {
    ...
    const isMobileMenuOpen = props.isMobileMenuOpen !== undefined ? props.isMobileMenuOpen : localIsOpen;
    const setIsMobileMenuOpen = props.setIsMobileMenuOpen || setLocalIsOpen;
